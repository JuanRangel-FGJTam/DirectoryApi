...
namespace AuthApi.Helper
{
    public class EmailTemplates
    {
        ...
        {
            return @"<body><table style='margin:0 auto;border-collapse:collapse;' class='content' width='600' border='0' cellspacing='0' cellpadding='0'><tr><td class='body' style='padding:10px 40px;text-align:left;font-size:16px;line-height:1.6;'><p>Le informamos que la dirección de correo electrónico asociada a su cuenta ha sido actualizada exitosamente.</p><p>Nuevo correo electrónico: <b>{{new_email}}</b><br/>Fecha: <b>{{date}}</b></p><p>Si usted realizó esta modificación, no necesita hacer nada más.<br/>Si no ha solicitado este cambio, por favor comuníquese con nosotros de inmediato para proteger la seguridad de su cuenta.</p></td></tr></table><div style='margin-top:2rem;text-align:center;'>Atentamente</div><div style='padding-top:0.2rem;text-align:center;'><b>Fiscalía General de Justicia del Estado de Tamaulipas</b></div></body>".Replace("{{new_email}}", newEmail).Replace("{{date}}", date);
        }
    }
}